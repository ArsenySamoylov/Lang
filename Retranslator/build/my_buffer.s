	...
	.text
.Ltext0:
	.file 0 "/home/arsenyfucker/Cprojects/Lang/Translator/Retranslator" "./ATC/Buffer/my_buffer.cpp"
	.section	.rodata
	.align 32
...
.LEHB1:
	...
	addq	$16, %rsp
	movl	%eax, %r14d
	.loc 1 298 248 is_stmt 1 discriminator 5
	jmp	.L165
.L164:
	.loc 1 300 17
	movq	-152(%rbp), %rax
...
.LEHB4:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 312 450 discriminator 7
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %r13
	.loc 1 312 456 discriminator 7
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
	...
	addq	$16, %rsp
	movl	%eax, %r13d
	.loc 1 312 253 is_stmt 1 discriminator 14
	jmp	.L179
.L178:
	.cfi_escape 0x2e,0
	.loc 1 314 52
...
.L180:
	...
	addq	$16, %rsp
	movl	%eax, %r13d
	.loc 1 315 168 is_stmt 1 discriminator 3
	jmp	.L179
.L181:
	.loc 1 317 29
	movq	-152(%rbp), %rax
