	...
	.text
.Ltext0:
	.file 0 "/home/arsenyfucker/Cprojects/Lang/Translator/Retranslator" "../Common/Structures/Tabels/NameTable.cpp"
	.bss
	.align 32
...
.LFB2275:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 155 258 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 155 264 discriminator 1
	leaq	.LC36(%rip), %r8
	movl	$155, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 155 489 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 155 495 discriminator 1
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
...
.L96:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 156 258 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 156 264 discriminator 1
	leaq	.LC36(%rip), %r8
	movl	$156, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 156 489 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 156 495 discriminator 1
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
...
.LFB2276:
	...
	cmpq	$0, -40(%rbp)
	jne	.L115
	.loc 1 178 45 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rcx
	.loc 1 178 51 discriminator 1
	leaq	.LC2(%rip), %rax
	movq	%rax, %rdx
	leaq	.LC3(%rip), %rax
	movq	%rax, %rsi
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 178 255 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 178 261 discriminator 1
	leaq	.LC39(%rip), %r8
	movl	$178, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 178 486 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 178 492 discriminator 1
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 178 92 discriminator 1
	leaq	.LC10(%rip), %rax
	movq	%rax, %rdi
	call	system@PLT
	.loc 1 178 115 discriminator 1
	movl	$-2, %eax
	jmp	.L116
.L115:
	.loc 1 180 53
...
.LFB2278:
	...
	cmpq	$0, -40(%rbp)
	jne	.L132
	.loc 1 225 49 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rcx
	.loc 1 225 55 discriminator 1
	leaq	.LC43(%rip), %rax
	movq	%rax, %rdx
	leaq	.LC3(%rip), %rax
	movq	%rax, %rsi
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 225 267 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 225 273 discriminator 1
	leaq	.LC44(%rip), %r8
	movl	$225, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 225 498 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 225 504 discriminator 1
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 225 92 discriminator 1
	leaq	.LC10(%rip), %rax
	movq	%rax, %rdi
	call	system@PLT
	.loc 1 225 134 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	.loc 1 225 156 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 225 169 discriminator 1
	subq	$8, %rsp
	pushq	$225
	leaq	.LC45(%rip), %r9
	movl	$225, %r8d
...
.L144:
	...
	movq	-40(%rbp), %rax
	movq	(%rax), %rdx
	.loc 1 249 43 is_stmt 1 discriminator 2
	movl	-20(%rbp), %eax
	cltq
	.loc 1 249 44 discriminator 2
	salq	$3, %rax
	addq	%rdx, %rax
	.loc 1 249 23 discriminator 2
	movq	%rax, %rdx
	movq	%rdx, %rcx
	shrq	$3, %rcx
	addq	$2147450880, %rcx
...
.L145:
	...
	.loc 1 241 5 is_stmt 1 discriminator 2
	addl	$1, -20(%rbp)
.L141:
...
.L146:
	...
	movq	-40(%rbp), %rax
	movl	12(%rax), %eax
	.loc 1 241 23 is_stmt 1 discriminator 1
	cmpl	%eax, -20(%rbp)
	jl	.L147
.LBE4:
	.loc 1 252 24
...
.LFE2278:
	...
	.section	.rodata
.LC49:
	.string	"1 32 24 12 func_260:260"
	.align 32
.LC50:
	.string	"AddTable"
	.zero	55
...
.LEHE9:
	...
	jne	.L153
.LEHB10:
	.loc 1 261 49 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rcx
	.loc 1 261 55 discriminator 1
	leaq	.LC43(%rip), %rax
	movq	%rax, %rdx
	leaq	.LC3(%rip), %rax
	movq	%rax, %rsi
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 261 267 discriminator 4
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 261 273 discriminator 4
	leaq	.LC51(%rip), %r8
	movl	$261, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 261 498 discriminator 7
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %r14
	.loc 1 261 504 discriminator 7
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 261 27 discriminator 9
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 261 33 discriminator 9
	movl	$261, %ecx
	leaq	.LC50(%rip), %rax
	movq	%rax, %rdx
	leaq	.LC9(%rip), %rax
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 261 92 discriminator 11
	leaq	.LC10(%rip), %rax
	movq	%rax, %rdi
	call	system@PLT
	.loc 1 261 134 discriminator 12
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 261 150 discriminator 12
	leaq	.LC50(%rip), %r8
	movl	$261, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	_ZN6Logger13LogMsgNullRetEPKcz@PLT
	.loc 1 261 242 discriminator 14
	movl	$0, %r14d
	jmp	.L154
.L153:
	.loc 1 263 23
...
.L156:
	...
	testb	%al, %al
	je	.L157
	.loc 1 264 82 discriminator 2
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 264 88 discriminator 2
	movl	$264, %ecx
	leaq	.LC50(%rip), %rax
	movq	%rax, %rdx
	leaq	.LC52(%rip), %rax
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 264 207 discriminator 4
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 264 223 discriminator 4
	leaq	.LC50(%rip), %r8
	movl	$264, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
...
.LFB2280:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 280 267 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 280 273 discriminator 1
	leaq	.LC53(%rip), %r8
	movl	$280, %ecx
	leaq	.LC1(%rip), %rax
	movq	%rax, %rdx
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 280 498 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 280 504 discriminator 1
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
