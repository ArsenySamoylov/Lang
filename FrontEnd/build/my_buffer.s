...
.LEHB1:
	...
	.loc 1 298 164 discriminator 6
	addq	$16, %rsp
	movl	%eax, %r14d
	.loc 1 298 355 is_stmt 1 discriminator 6
	jmp	.L165
.L164:
	.loc 1 300 17
	movq	-152(%rbp), %rax
...
.LEHB4:
	...
	.cfi_escape 0x2e,0x10
	call	_ZN6Logger9LogMsgRetEiPKcz@PLT
	.loc 1 312 169 discriminator 15
	addq	$16, %rsp
	movl	%eax, %r13d
	.loc 1 312 360 is_stmt 1 discriminator 15
	jmp	.L179
.L178:
	.cfi_escape 0x2e,0
	.loc 1 314 52
...
.L180:
	...
	.cfi_escape 0x2e,0x10
	call	_ZN6Logger9LogMsgRetEiPKcz@PLT
	.loc 1 315 84 discriminator 4
	addq	$16, %rsp
	movl	%eax, %r13d
	.loc 1 315 275 is_stmt 1 discriminator 4
	jmp	.L179
.L181:
	.loc 1 317 29
	movq	-152(%rbp), %rax
