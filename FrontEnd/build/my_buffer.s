...
.LLSDACSE2284:
	...
	.section	.rodata
.LC21:
	.string	"1 32 24 12 func_307:307"
	.align 32
.LC22:
	.string	"buf"
	.zero	60
...
.L178:
	...
	call	__asan_report_store8@PLT
.L180:
	.loc 1 310 17 discriminator 2
	movq	-152(%rbp), %rdx
	movq	%rax, (%rdx)
	.loc 1 311 15 is_stmt 1 discriminator 2
	movq	-152(%rbp), %rax
	movq	(%rax), %rax
...
.L201:
	...
	movq	-104(%rbp), %rax
	movl	16(%rax), %eax
	.loc 1 346 33 is_stmt 1 discriminator 1
	leal	1(%rax), %edx
	movq	-104(%rbp), %rax
	movl	%edx, 16(%rax)
...
.L202:
	...
	movq	-104(%rbp), %rax
	movl	$1, 20(%rax)
	.loc 1 349 22 is_stmt 1 discriminator 1
	movq	-104(%rbp), %rax
	movq	8(%rax), %rcx
...
.L211:
	.loc 1 340 12 discriminator 1
	movzbl	(%rdx), %eax
	.loc 1 339 50 is_stmt 1 discriminator 1
	cmpb	$11, %al
	je	.L209
	.loc 1 340 39
	movq	-104(%rbp), %rax
