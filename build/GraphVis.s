...
.LFB2276:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 122 177 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 122 183 discriminator 1
	movl	$122, %r8d
	leaq	.LC20(%rip), %rax
	movq	%rax, %rcx
	leaq	.LC21(%rip), %rax
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 122 370 discriminator 1
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 122 376 discriminator 1
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
...
.LEHB1:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 153 177 discriminator 4
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 153 183 discriminator 4
	movl	$153, %r8d
	leaq	.LC20(%rip), %rax
	movq	%rax, %rcx
	leaq	.LC27(%rip), %rax
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 153 370 discriminator 7
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rbx
	.loc 1 153 376 discriminator 7
	movl	$14, %edi
	call	strerror@PLT
	movq	%rax, %rcx
	movl	$14, %edx
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 153 27 discriminator 9
	call	_ZN6Logger11getInstanceEv@PLT
	movq	%rax, %rdi
	.loc 1 153 33 discriminator 9
	movl	$153, %ecx
	leaq	.LC27(%rip), %rax
	movq	%rax, %rdx
	leaq	.LC24(%rip), %rax
	...
	movl	$0, %eax
	call	_ZN6Logger3logEPKcz@PLT
	.loc 1 153 92 discriminator 11
	leaq	.LC25(%rip), %rax
	movq	%rax, %rdi
	call	system@PLT
	.loc 1 153 110 discriminator 12
	call	abort@PLT
.L27:
	.loc 1 154 13
	movq	-408(%rbp), %rax
...
.LLSDACSB2277:
	.uleb128 .LEHB0-.LFB2277
	.uleb128 .LEHE0-.LEHB0
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB1-.LFB2277
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L45-.LFB2277
	.uleb128 0
	.uleb128 .LEHB2-.LFB2277
	.uleb128 .LEHE2-.LEHB2
	.uleb128 0
	.uleb128 0
.LLSDACSE2277:
...
.LFB2944:
	...
	cmpl	$1, -4(%rbp)
	jne	.L50
	.loc 1 201 5 is_stmt 0 discriminator 1
	cmpl	$65535, -8(%rbp)
	jne	.L50
