...
.L236:
	.loc 1 376 57 discriminator 1
	movl	-32(%r12), %eax
	.loc 1 376 52 is_stmt 1 discriminator 1
	testl	%eax, %eax
	jne	.L235
	.loc 1 376 52 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L237
.L235:
	.loc 1 376 52 discriminator 4
	movl	$0, %eax
.L237:
	.loc 1 376 5 is_stmt 1 discriminator 6
	testb	%al, %al
	je	.L238
	.loc 1 377 16
	leaq	-32(%r12), %rax
...
.L252:
	.loc 1 389 55 discriminator 1
	movl	-32(%r12), %eax
	.loc 1 389 50 is_stmt 1 discriminator 1
	testl	%eax, %eax
	jne	.L251
	.loc 1 389 50 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L253
.L251:
	.loc 1 389 50 discriminator 4
	movl	$0, %eax
.L253:
	.loc 1 389 5 is_stmt 1 discriminator 6
	testb	%al, %al
	je	.L254
	.loc 1 390 35
	call	_ZN6Logger11getInstanceEv@PLT
...
.L266:
	...
	testb	%al, %al
	je	.L268
	.loc 1 403 56 is_stmt 0
	movq	%rdx, %rdi
	call	__asan_report_load4@PLT
.L268:
	.loc 1 403 56 discriminator 1
	movl	-32(%r12), %eax
	.loc 1 403 51 is_stmt 1 discriminator 1
	testl	%eax, %eax
	jne	.L267
	.loc 1 403 51 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L269
.L267:
	.loc 1 403 51 discriminator 4
	movl	$0, %eax
.L269:
	.loc 1 403 5 is_stmt 1 discriminator 6
	testb	%al, %al
	je	.L270
	.loc 1 404 35
	call	_ZN6Logger11getInstanceEv@PLT
